...
public class PermissionInterceptor extends AbstractInterceptor {
    ...
    private Object invokePermission(MethodInvocation invocation, Permission permissionAnnotation) throws Throwable {
        ...
        LOG.info("权限拦截：Permission [name={}, label={}, description={}, proxyType={}, proxiedClass={}, method={}, parameterTypesValue={}]", name, label,
                description, proxyType, proxiedClassName, methodName, parameterTypesValue);

        // 跟数据库中的权限数据比对，如果判断无权限，可以抛出异常
        // throw new PermissionException("No permission to proceed method [name=" + methodName + ", parameterTypes=" + parameterTypesValue + "],
        // permissionName=" + name + ", permissionLabel=" + label);
