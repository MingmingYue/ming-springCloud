...
import com.core.config.configuration.JwtConfiguration;
...
public class MingAuthorizationConfiguration extends AuthorizationServerConfigurerAdapter {
    ...
    public JwtAccessTokenConverter jwtAccessTokenConverter() {
        MingJwtAccessTokenConverter jwtAccessTokenConverter = new MingJwtAccessTokenConverter();
